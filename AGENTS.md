...
- 每次推进 agent 化或调整 agent 化 roadmap，也同步更新 Obsidian 备忘：`/Users/danxiao/Desktop/Wilf's 2nd Brain/ultreia/Agent 化推进.md`；工作流程 / 收尾清单变化同步更新 `/Users/danxiao/Desktop/Wilf's 2nd Brain/ultreia/工作流程.md`。Obsidian 是长期备忘，不替代 repo 内 source of truth。
