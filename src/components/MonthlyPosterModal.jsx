...
// without the source icon's topographic lines or chrome frame. The poster asset
// keeps the metallic moss mark and a soft dark ground so it reads as a restrained
// watermark instead of a hard cutout.
const THEMES = {
  day: {
    bg: "#f1ede1",
    ink: "#151610",
...
// ── The poster ──────────────────────────────────────────────────────────────
// The cleaned logo background mark (route + ridges, no contour lines / frame,
// generated by scripts/make-poster-mark.mjs). It's a square; place it
