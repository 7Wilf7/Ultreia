...
const dict = {
  ...
  "api.desc_multi":           { en: "Legacy personal DeepSeek key settings. Normal AI Coach calls use Wallet and do not require a personal key.", zh: "旧版个人 DeepSeek Key 设置。现在 AI Coach 默认走钱包扣费，不需要个人 Key。" },
  "api.desc_pick_provider":   { en: "DeepSeek is used automatically for AI Coach.", zh: "AI Coach 会自动使用 DeepSeek。" },
  ...
  "api.model_locked_hint":    { en: "Locked to the built-in DeepSeek model. There is no per-user model setting.", zh: "固定使用内置 DeepSeek 模型，没有用户侧模型设置。" },
  ...
  "coach.memory_nightly_review_desc": { en: "When there is new coach chat today, run once overnight and create a fact review card. It never changes active facts until you accept it, and it may use one AI call.", zh: "当天有新的教练对话时，夜间最多运行一次并生成事实审核卡片。你接受前不会改动当前事实，可能产生一次 AI 调用费用。" },
