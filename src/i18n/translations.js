...
const dict = {
  ...
  "coach.free_used":          { en: "⚠ Your free AI allowance is used up. Add your own DeepSeek API key in Settings to keep chatting.", zh: "⚠ 免费 AI 额度已用完。在设置里填入你自己的 DeepSeek API Key 即可继续。" },
  ...
  "coach.cost_free":          { en: "Free allowance · {tokens} tokens", zh: "免费额度 · {tokens} tokens" },
