...
const dict = {
  ...
  "coach.memory_action_reason": { en: "This action will save the kept points as active Memory facts for future chats.", zh: "这个动作会把你保留的条目保存为当前记忆事实，供之后对话使用。" },
  "coach.memory_action_executed": { en: "Memory action executed. The accepted facts are now active.", zh: "记忆动作已执行。已接受的事实已经启用。" },
  "coach.memory_action_rejected": { en: "Memory action ignored. No Memory facts were changed.", zh: "记忆动作已忽略。记忆事实没有改动。" },
  ...
  "coach.recent_agent_actions": { en: "Recent Agent Actions", zh: "最近 Agent 动作" },
  "coach.agent_actions_hint": { en: "The latest 10 action cards proposed by the coach, with your decision and execution result. Open one to ask the coach about that action, or long-press a record to delete the action record only.", zh: "这里显示最近 10 条教练提出的动作卡片，以及你的决定和执行结果。展开后可以带着这条动作继续问教练；长按记录可以只删除这条动作记录。" },
  "coach.agent_actions_empty": { en: "No agent actions yet. Review a coach reply or update Memory first.", zh: "还没有 Agent 动作。先审核一条教练回复，或从对话更新长期记忆。" },
  "coach.agent_actions_items": { en: "Action items", zh: "动作内容" },
  "coach.agent_actions_changes": { en: "Plan changes", zh: "计划修改" },
  "coach.agent_actions_payload": { en: "Payload", zh: "动作内容" },
  "coach.agent_actions_result": { en: "Result", zh: "执行结果" },
  ...
  "coach.agent_action_type_create_plans": { en: "Import calendar plan", zh: "导入日历计划" },
  "coach.agent_action_type_memory_update": { en: "Update Memory", zh: "更新 Memory" },
  "coach.agent_action_type_unknown": { en: "Agent action", zh: "Agent 动作" },
  "coach.agent_action_status_proposed": { en: "Proposed", zh: "已提议" },
  "coach.agent_action_status_accepted": { en: "Accepted", zh: "已接受" },
  "coach.agent_action_status_executing": { en: "Executing", zh: "执行中" },
  "coach.agent_action_status_executed": { en: "Executed", zh: "已执行" },
  "coach.agent_action_status_rejected": { en: "Ignored", zh: "已忽略" },
  ...
  "coach.agent_action_ask_coach": { en: "Ask coach about this action", zh: "带着这条动作问教练" },
  "coach.agent_action_delete_failed": { en: "Failed to delete action: {msg}", zh: "删除动作记录失败：{msg}" },
  ...
  "coach.calendar_btn_hint":  { en: "When on, a \"Review action\" button appears below each coach reply. Tap it to ask the AI to extract concrete plans from that reply, then review the action before adding anything to Calendar.", zh: "开启时，每条教练回复下方会出现「审核建议动作」按钮。点击会让 AI 从该回复中提取具体训练计划，并在加入日历前先审核这个动作。" },
  ...
  "coach.action_modal_eyebrow": { en: "Agent action review",   zh: "Agent 动作审核" },
  "coach.action_card_title":    { en: "Suggested action",      zh: "建议动作" },
  ...
  "coach.action_status_accepted": { en: "This action was accepted and is being saved. If saving fails, the action will be marked as failed.", zh: "这个动作已接受，正在保存。如果保存失败，会标记为执行失败。" },
  "coach.action_status_executing": { en: "This action is being executed.", zh: "这个动作正在执行中。" },
  ...
  "coach.action_status_failed": { en: "This action failed while saving. You can review it again or re-extract a fresh action from the reply.", zh: "这个动作保存时失败。你可以重新查看，或从这条回复重新提炼。" },
  "coach.action_status_cancelled": { en: "This action was cancelled.", zh: "这个动作已取消。" },
  ...
  "coach.action_create_plans_reason": { en: "This action will apply {n} calendar item(s) from the coach's reply: {workouts} new plan(s), {updates} plan change(s), {rests} planned rest day(s).", zh: "这个动作会应用教练回复中的 {n} 条日历安排：{workouts} 条新增计划，{updates} 条计划修改，{rests} 个计划休息日。" },
  "coach.action_will_execute":  { en: "Will execute",          zh: "将执行" },
  "coach.action_no_selected":   { en: "No selected item. Select at least one row below to execute this action.", zh: "当前没有选中条目。至少选择下方一条计划后才能执行。" },
  "coach.action_more_items":    { en: "+ {n} more item(s)",    zh: "另有 {n} 条" },
  "coach.action_replace_warning": { en: "Existing planned workout(s) on {dates} will be replaced. Completed workouts are not touched.", zh: "{dates} 已有计划训练，会被这次动作替换；已完成训练不会受影响。" },
  "coach.action_update_badge":   { en: "Modify",                zh: "修改" },
  "coach.action_reject":        { en: "Ignore",                zh: "忽略" },
  ...
  "coach.import_confirm":       { en: "Accept and execute ({n})", zh: "接受并执行（{n}）" },
