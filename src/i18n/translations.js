...
const dict = {
  ...
  "api.model_hint_editable":  { en: "Tap a chip to fill in, or type any model ID below. The free-text input lets you use new model names without waiting for an app update.", zh: "点 chip 自动填入，或在下方输入任意模型 ID 保存。这样新模型不需要等 app 更新也能用。" },
  "api.model_custom_placeholder": { en: "Any model ID supported by your provider…", zh: "Provider 支持的任意模型 ID…" },
