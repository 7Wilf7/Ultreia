...
const dict = {
  ...
  "coach.agent_actions_hint": { en: "The latest 10 action cards proposed by the coach, with your decision and execution result. Long-press a record to delete the action record only.", zh: "这里显示最近 10 条教练提出的动作卡片，以及你的决定和执行结果。长按记录可以只删除这条动作记录。" },
