...
const dict = {
  ...
  "wallet.pricing_body":        { en: "AI Coach uses actual model usage in CNY × 1.2, rounded to cents, minimum ¥0.01 per successful reply. DeepSeek: input ¥3.16 / 1M tokens, output ¥6.32 / 1M tokens. Claude: input ¥29.10 / 1M tokens, output ¥145.50 / 1M tokens. Weather: ¥0.01 per successful request.", zh: "AI Coach 按模型实际用量折算人民币 × 1.2 扣费，四舍五入到分，每次成功回复最低 ¥0.01。DeepSeek：输入 ¥3.16 / 百万 tokens，输出 ¥6.32 / 百万 tokens。Claude：输入 ¥29.10 / 百万 tokens，输出 ¥145.50 / 百万 tokens。天气：每次成功获取扣 ¥0.01。" },
