...
const dict = {
  ...
  "settings.export_backup_desc":{ en: "Download a JSON copy of workouts, races, notes and coach chats. API keys are not exported.", zh: "下载训练、比赛、笔记和教练对话的 JSON 副本；不会导出 API 密钥。" },
  "settings.export_backup_done":{ en: "Backup file generated.", zh: "备份文件已生成。" },
