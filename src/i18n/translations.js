...
const dict = {
  ...
  "coach.action_create_plans_reason": { en: "This action will apply {n} calendar item(s) from the coach's reply: {workouts} workout plan(s), {rests} planned rest day(s).", zh: "这个动作会应用教练回复中的 {n} 条日历安排：{workouts} 条训练计划，{rests} 个计划休息日。" },
