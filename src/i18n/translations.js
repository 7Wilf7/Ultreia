...
const dict = {
  ...
  "activities.coach_review_body":  { en: "Uses up to {shown} of {n} new activities. It will prefill the coach message, not send automatically.", zh: "最多取 {n} 条里的 {shown} 条生成点评消息；只预填，不自动发送。" },
