...
const dict = {
  ...
  "wallet.pricing_deepseek_body": { en: "Input ¥3.16 / 1M tokens, cache-hit input ¥0.026 / 1M tokens, output ¥6.32 / 1M tokens. Cache-hit input is much cheaper, so a long prompt can still hit the ¥0.01 minimum when most input is cached. AI Coach chat and daily push are charged as actual model cost × 1.2, rounded to cents, minimum ¥0.01 per successful reply.", zh: "输入 ¥3.16 / 百万 tokens，缓存命中输入 ¥0.026 / 百万 tokens，输出 ¥6.32 / 百万 tokens。缓存命中的输入非常便宜，所以当大部分输入命中缓存时，很长的 prompt 也可能只触发 ¥0.01 最低扣费。AI Coach 对话和每日推送都按实际模型成本 × 1.2 扣费，四舍五入到分，每次成功回复最低 ¥0.01。" },
  "wallet.pricing_claude_title": { en: "Claude",               zh: "Claude" },
  "wallet.pricing_claude_body":  { en: "Input ¥29.10 / 1M tokens, cache-write ¥36.375 / 1M tokens, cache-read ¥2.91 / 1M tokens, output ¥145.50 / 1M tokens. Charged as actual model cost × 1.2, rounded to cents, minimum ¥0.01 per successful reply.", zh: "输入 ¥29.10 / 百万 tokens，缓存写入 ¥36.375 / 百万 tokens，缓存读取 ¥2.91 / 百万 tokens，输出 ¥145.50 / 百万 tokens。按实际模型成本 × 1.2 扣费，四舍五入到分，每次成功回复最低 ¥0.01。" },
  ...
  "coach.choose_model_hint":   { en: "Choose DeepSeek / Claude", zh: "选择 DeepSeek / Claude" },
