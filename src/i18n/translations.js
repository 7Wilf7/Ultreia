...
const dict = {
  ...
  "settings.check_update":   { en: "检查更新",              zh: "检查更新" },
  "settings.update_checking": { en: "检查中…",              zh: "检查中…" },
  "settings.update_latest":  { en: "已是最新版本",           zh: "已是最新版本" },
  "settings.update_available": { en: "有新版本",            zh: "有新版本" },
  "settings.update_download": { en: "下载 APK",             zh: "下载 APK" },
  "settings.update_install":  { en: "立即更新",             zh: "立即更新" },
  "settings.update_downloading": { en: "下载中…",           zh: "下载中…" },
  "settings.update_installing":  { en: "正在打开安装…",      zh: "正在打开安装…" },
  "settings.update_install_failed": { en: "应用内安装失败 —— 已改用浏览器下载。", zh: "应用内安装失败 —— 已改用浏览器下载。" },
  "settings.update_network_hint": { en: "看起来是网络/DNS 问题 —— 请检查网络后重试。", zh: "看起来是网络/DNS 问题 —— 请检查网络后重试。" },
  "settings.update_view":    { en: "查看更新说明",           zh: "查看更新说明" },
  "settings.update_error":   { en: "无法检查更新",           zh: "无法检查更新" },
  "settings.view_recent":    { en: "查看最近更新",           zh: "查看最近更新" },
  "settings.update_new_title": { en: "新版本 v{v}",          zh: "新版本 v{v}" },
  "settings.update_recent_title": { en: "最新版本 v{v}",     zh: "最新版本 v{v}" },
