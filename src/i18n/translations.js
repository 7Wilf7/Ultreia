...
const dict = {
  ...
  "races.lookup_name_web":    { en: "✓ Name updated (no categories found). Fill date/distance manually.", zh: "✓ 已更新名称（未找到组别）。请手动填日期/距离。" },
  "races.lookup_name_date_web":{ en: "✓ Name and date updated (no categories found). Fill distance manually.", zh: "✓ 已更新名称和日期（未找到组别）。请手动填距离。" },
  ...
  "races.distance_placeholder":{ en: "Distance (km)",       zh: "距离 (km)" },
