...
const dict = {
  ...
  "coach.action_create_plans_title": { en: "Create {n} calendar plan(s)", zh: "创建 {n} 条日历计划" },
  "coach.action_create_plans_hint": { en: "The coach proposed dated workouts. Review the action, adjust the details, then confirm only the items you want to add.", zh: "教练提出了带日期的训练安排。先审核这个动作，调整细节后，只确认你想加入日历的条目。" },
  "coach.action_create_plans_reason": { en: "This action will add {n} calendar plan item(s) from the coach's reply.", zh: "这个动作会把教练回复中的 {n} 条计划加入日历。" },
