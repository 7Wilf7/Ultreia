...
const dict = {
  ...
  "activities.import_review_bulk_body": { en: "{n} activities selected. Bulk imports skip per-activity RPE so import stays fast.", zh: "已选 {n} 条活动。批量导入不逐条填写 RPE，避免导入变慢。" },
  ...
  "activities.import_review_rpe_placeholder": { en: "1-10, optional", zh: "1-10，可不填" },
  "activities.import_review_rpe_bulk": { en: "For 6+ activities, import first and edit RPE later on the activity card.", zh: "6 条及以上先导入，之后在训练卡片里补 RPE。" },
